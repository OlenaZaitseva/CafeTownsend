...
public class EmployeeDetailsPage {
    ...
    private static final By CANCEL_BUTTON_LOCATOR = By.xpath("//a[text()='Cancel']");
    ...
    private static final By BACK_BUTTON_LOCATOR = By.className("bBack");
    ...
    public boolean isEmployeeDetailsdisplayed() {
        boolean isEmployeeDetailsdisplayed = getEmployeeFirstName().isDisplayed();
        return isEmployeeDetailsdisplayed;
    }
    ...
    public WebElement getEmployeeStartDate() {
        WebElement element = Navigation.getDriver().findElement(STARTDATE_LOCATOR);
        return element;
    }

    public boolean isDataInvalid(WebElement element) {
        boolean isInvalid = element.getAttribute("class").contains("invalid");
        return isInvalid;
    }
}
